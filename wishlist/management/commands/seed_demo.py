        ...
        inventario = [
            {
                ...
                "category": "Auriculares",
                "condition": OwnedItem.Condition.FAIR,
                "usage_frequency": OwnedItem.UsageFrequency.WEEKLY,
                "purchase_price": Decimal("19.90"),
                "purchase_date": today - timedelta(days=400),
                "last_used_at": today - timedelta(days=2),
            },
            {
                "name": "Mochila de trekking 30L",
                "category": "Mochilas",
                "condition": OwnedItem.Condition.GOOD,
                "usage_frequency": OwnedItem.UsageFrequency.MONTHLY,
                "purchase_price": Decimal("60.00"),
                "purchase_date": today - timedelta(days=800),
                "last_used_at": today - timedelta(days=30),
            },
            {
                "name": "Teclado de membrana",
                "category": "Teclados",
                "condition": OwnedItem.Condition.GOOD,
                "usage_frequency": OwnedItem.UsageFrequency.DAILY,
                "purchase_price": Decimal("25.00"),
                "purchase_date": today - timedelta(days=500),
                "last_used_at": today - timedelta(days=1),
            },
            {
                "name": "Altavoz bluetooth pequeño",
                "category": "Ocio",
                "condition": OwnedItem.Condition.LIKE_NEW,
                "usage_frequency": OwnedItem.UsageFrequency.RARELY,
                "purchase_price": Decimal("35.00"),
                "purchase_date": today - timedelta(days=300),
                "last_used_at": today - timedelta(days=90),
            },
            {
